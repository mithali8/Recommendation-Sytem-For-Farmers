...
def compare(beetData, date):
  ...
  return data
data = {'Market': ['RAMANAGARA', 'KOLAR', 'MYSURU'], 'Actual': [2200.0, 1100.0, 850.0], 'Predicted': [2476.3929601943305, 970.6745613832617, 769.9967510076508]}
#data = json.dumps(data)
#data3 = [{'Market': ['RAMANAGARA', 'KOLAR', 'MYSURU'], 'Actual': [2200.0, 1100.0, 850.0], 'Predicted': [2476.3929601943305, 970.6745613832617, 769.9967510076508]}]
data2=[
    {
        'Market':'RAMANAGARA',
        'Actual': '2200.0',
        'Predicted': '2476.3929601943305'
    },
    
    {
        'Market':'KOLAR',
        'Actual': '1100.0',
        'Predicted': '970.6745613832617'
    },
    {
        'Market':'MYSURU',
        'Actual': '850.0',
        'Predicted': '769.9967510076508'
    }
]
...
######## 11TH FEB - adding flask to final esa to check #################
