...
def get_data_from_html():
        ...
        dates_array = []
        dates_array.append(end_date.strftime('%d %B %Y'))
        dates_array.append(date1.strftime('%d %B %Y'))
        dates_array.append(date2.strftime('%d %B %Y'))

        return render_template('index.html', x = data, best = bm, crop = crp, x1=data1, x2=data2, date = end_date.strftime('%d %B %Y'), date1 = date1.strftime('%d %B %Y'), date2=date2.strftime('%d %B %Y'), best_price = best_in_the_three_days, dates_array=dates_array)
